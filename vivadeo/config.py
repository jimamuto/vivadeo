...
class Settings(BaseSettings):
    ...
    auto_llm_api_key: str | None = Field(None, alias="VIVADEO_AUTO_LLM_API_KEY")
    auto_llm_base_url: str | None = Field(None, alias="VIVADEO_AUTO_LLM_BASE_URL")
    auto_llm_model: str = Field("gpt-5.6-luna", alias="VIVADEO_AUTO_LLM_MODEL")
    auto_llm_timeout: int = Field(120, alias="VIVADEO_AUTO_LLM_TIMEOUT")
    auto_llm_fallback_api_key: str | None = Field(None, alias="VIVADEO_AUTO_LLM_FALLBACK_API_KEY")
    auto_llm_fallback_base_url: str | None = Field(None, alias="VIVADEO_AUTO_LLM_FALLBACK_BASE_URL")
    auto_llm_fallback_model: str | None = Field(None, alias="VIVADEO_AUTO_LLM_FALLBACK_MODEL")
    ...
    visual_calibration_path: str | None = Field(None, alias="VIVADEO_VISUAL_CALIBRATION_PATH")
