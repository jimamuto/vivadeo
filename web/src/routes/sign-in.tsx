...
function SignInPage() {
  ...
  const params = { error: query.get("error") || undefined, verify: query.get("verify") || undefined, reset: query.get("reset") || undefined };
    ...
    <div className="shell page">
      ...
      <section className="auth-shell fade-in">
        ...
        <div className="card auth-panel">
          ...
          <p className="muted" style={{ marginTop: 16 }}><Link to="/forgot-password">Forgot password?</Link></p>
        </div>
      </section>
    </div>
  );
...
export const Route = createFileRoute("/sign-in")({ loader: () => getRequestSession(), component: SignInPage as any });
