...
function ResetPasswordPage() {
  const error = new URLSearchParams(useLocation().searchStr).get("error") || undefined;
...
export const Route = createFileRoute("/reset-password")({ component: ResetPasswordPage as any });
