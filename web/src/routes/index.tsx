    ...
    <div className="shell page">
      <header className="topbar">
        <div className="topbar-shell">
          <Link to="/" className="brand">Vivadeo</Link>
          <div className="nav-center">
            <Link to="/" className="nav-link">Home</Link>
            <Link to="#about" className="nav-link">About</Link>
            <Link to="#features" className="nav-link">Services</Link>
          ...
          <div className="nav-actions">
            {signedIn ? (
              <>
                <Link to="/dashboard" className="button-secondary">Console</Link>
                <Link to="/settings" className="nav-user" aria-label="Profile">{profileInitial}</Link>
      ...
      <section className="hero hero-home fade-in">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <Link to={signedIn ? "/dashboard" : "/sign-up"} className="button">Open console</Link>
            <Link to="#features" className="button-secondary">See services</Link>
          </div>
        </div>
      ...
      <section className="pricing-band">
        ...
        <div className="pricing-grid">
          <article className="pricing-card">
            ...
            <Link to={signedIn ? "/dashboard" : "/sign-up"} className="button-secondary pricing-cta">Get started</Link>
          </article>
          <article className="pricing-card">
            <h3>Archive</h3>
            ...
            <Link to={signedIn ? "/dashboard" : "/sign-up"} className="button-secondary pricing-cta">Talk to sales</Link>
          </article>
        </div>
        <div className="pricing-pro">
          <h3>Professional</h3>
          <p>Designed for flexibility, with advanced tools for custom tailoring.</p>
          <Link to={signedIn ? "/dashboard" : "/sign-in"} className="button pricing-cta">Open console</Link>
        </div>
      </section>
      ...
      <section className="integration-band" id="contact">
        <div>
          ...
          <Link to={signedIn ? "/dashboard" : "/sign-up"} className="button-secondary">Work with us</Link>
        </div>
      ...
      <section className="cta-band">
        ...
        <Link to={signedIn ? "/dashboard" : "/sign-up"} className="button">Start free</Link>
      </section>
...
export const Route = createFileRoute("/")({ loader: () => getRequestSession(), component: HomePage as any });
