import { $ as validateAlgorithms, At as decoder, Dt as decode, Et as checkEncCryptoKey, Mt as uint32be, Nt as uint64be, Ot as encode$1, Q as checkKeyType, St as JWTClaimValidationFailed, Tt as invalidKeyInput, X as JWTClaimsBuilder, Z as validateClaimsSet, _t as JOSENotSupported, at as isDisjoint, bt as JWKInvalid, ct as assertNotSet, dt as unprotected, et as validateCrit, ft as assertCryptoKey, gt as JOSEAlgNotAllowed, ht as isKeyObject, it as sign, jt as encode, kt as concat, lt as decodeBase64url, mt as isKeyLike, nt as normalizeKey, ot as isJWK, pt as isCryptoKey, rt as checkKeyLength, st as isObject, tt as importJWK, ut as digest, vt as JWEDecryptionFailed, wt as JWTInvalid, xt as JWSInvalid, yt as JWEInvalid } from "./@better-auth/core+[...].mjs";
...
async function deriveKey$1(publicKey, privateKey, algorithm, keyLength, apu = /* @__PURE__ */ new Uint8Array(), apv = /* @__PURE__ */ new Uint8Array()) {
	...
	const otherInfo = concat(algorithmID, partyUInfo, partyVInfo, suppPubInfo, /* @__PURE__ */ new Uint8Array());
